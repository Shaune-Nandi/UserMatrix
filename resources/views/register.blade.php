...
@section('body')
    ...
    <div class="grid">
        <form action="/register" method="POST" class="justify-self-center bg-gray-100 rounded-md w-2/3 mt-5 mx-5 px-5 py-5">
            @csrf
            <h3 class="text-2xl ml-10 mb-6">Register</h3>
            ...
            <fieldset class="mt-10">
                ...
                @foreach($role as $role)
                    ...
                    <div class="flex items-center mb-1">
                        ...
                        <label for="role[]" class="ml-3 text-sm font-sm text-gray-900 dark:text-gray-300">{{ $role->name }}</label>
                    </div>
